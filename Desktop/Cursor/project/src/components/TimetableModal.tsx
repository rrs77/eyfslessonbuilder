...
interface TimetableModalProps {
  ...
  initialDay?: number; // Initial day for new class
  initialHour?: number; // Initial hour for new class
  className: string;
}
...
export function TimetableModal({
  ...
  onDeleteClass,
  initialDay,
  initialHour, // Initial hour for new class
  className
}: TimetableModalProps) {
  ...
  const { units } = useData(); // Get units from DataContext
