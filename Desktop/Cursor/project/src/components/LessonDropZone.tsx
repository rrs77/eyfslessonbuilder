...
interface LessonDropZoneProps {
  ...
  hideNotes?: boolean; // NEW: Hide notes section when using post-it note
}
...
export function LessonDropZone({
  ...
  hideNotes = false // NEW: Hide notes section when using post-it note
}: LessonDropZoneProps) {
  ...
  return (
    <>
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
        ...
        {/* Notes Section - Hidden when using post-it note */}
        {!hideNotes && (
