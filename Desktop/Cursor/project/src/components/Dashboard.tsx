...
export function Dashboard() {
  ...
  return (
    <DndProvider backend={HTML5Backend}>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-8">
            ...
            <TabsContent value="lesson-builder" className="mt-3">
              <LessonPlanBuilder 
                ...
                onEditComplete={() => setEditingLessonNumber(null)}
              />
            </TabsContent>
      ...
      {/* Lesson Edit Modal */}
      {showLessonEditModal && editingLessonNumber && (
        <>
          {console.log('Dashboard: Rendering LessonEditModal with:', {
            showLessonEditModal,
            editingLessonNumber,
            lessonData: allLessonsData[editingLessonNumber],
            theme
          })}
          <LessonEditModal
            isOpen={showLessonEditModal}
            onClose={() => {
              console.log('Dashboard: Closing lesson edit modal');
