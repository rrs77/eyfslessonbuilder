...
export function LoginForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-400 via-cyan-300 to-teal-200 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        {/* Header with Logo */}
        <div className="text-center mb-8">
          {/* Logo Image - 364x236px */}
          <img
            src="/cdlogo.png"
            alt="Curriculum Designer Logo"
            width={728}
            height={472}
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500">
            Curriculum Designer • From Rhythmstix
          </p>
        </div>
      </div>
    </div>
