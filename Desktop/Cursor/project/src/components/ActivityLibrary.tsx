...
export function ActivityLibrary({ 
  ...
  const { activities: allActivities, addActivity, updateActivity, deleteActivity, loading: dataLoading } = useData();
  const { getCategoryColor, subjects } = useSettings();
  
  // Get categories from activities data instead of settings
  ...
  }, [allActivities, getCategoryColor]);
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-purple-100 text-sm">
                {filteredAndSortedActivities.length} of {allActivities?.length || 0} activities
              </p>
            </div>
          </div>
